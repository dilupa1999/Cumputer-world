...
<head>
    ...
    <title>Selling History | Admins | Computerworld</title>
...
<body class=" main-body">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12  mt-3 mb-3 border shadow-lg  rounded" style="background-color: #74EBD5; background-image: linear-gradient(90deg,#74EBD5 0%,#9FACE6 100%);">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-1 mt-1 mb-3 d-grid">
                        <button class="btn btn-primary fw-bold mt-5" onclick="findSellings();">Find</button>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 mt-3">
                <div class="row">
                    ...
                    <div class="col-1 bg-secondary text-end shadow-lg rounded text-center">
                        <label class="form-label fs-5 fw-bold text-white">Invoice ID</label>
                    </div>
                    <div class="col-3 bg-body text-end shadow-lg rounded text-center">
                        <label class="form-label fs-5 fw-bold text-black">Product</label>
                    </div>
                    <div class="col-3 bg-secondary text-end shadow-lg rounded text-center">
                        <label class="form-label fs-5 fw-bold text-white">Buyer</label>
                    </div>
                    <div class="col-2 bg-body text-end shadow-lg rounded text-center ">
                    ...
                    <div class="col-2 bg-body text-end shadow-lg rounded text-center">
                        <label class="form-label fs-5 fw-bold text-dark">Status</label>
                    </div>
            ...
            <div class="col-12 mt-2" id="viewArea">
                ...
                ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-3 bg-secondary text-end shadow-lg rounded text-center">
                            <label class="form-label fs-5 fw-bold text-white mt-1 mb-1"><?php echo $seller_data["fname"] . " " . $seller_data["lname"]; ?></label>
                        </div>
                        <div class="col-2 bg-body text-end shadow-lg rounded text-center">
                        ...
                        <div class="col-2 bg-white d-grid shadow-lg rounded text-center">
