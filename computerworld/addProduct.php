...
<head>
    ...
    <title>Add Product | Computerworld</title>
                ...
                <div class="col-12">
                    <div class="row">
                        ...
                        <div class="col-12 text-center">
                            <h2 class="h2 text-dark fw-bold">Add a New Product</h2>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    ...
                                    <label class="form-label fw-bold">
                                        We are takign 10% of the product price From every product as a servise charge.
                                    </label>
                                </div>
