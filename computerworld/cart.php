...
<head>
    ...
    <title>Cart | Computerworld</title>
            ...
            ?>
                ...
                <div class="col-12 border border-1 border-primary rounded mb-3">
                    <div class="row main-body">
                        ...
                        <div class="col-12 text-center mt-0 animate__animated animate__slideInRight">
                            <label class="form-label fs-1 fw-bolder align-middle ">Cart <i class="bi bi-cart4 fs-1 text-success"></i></label>
                        </div>
                        ...
                        ?>
                            ...
                            <div class="col-12 col-lg-9 shadow-lg animate__animated animate__slideInUp">
                                <div class="row shadow-lg">
                                    ...
                                    ?>
                                        ...
                                        <div class="card mb-3 mx-0 col-12 shadow-lg">
                                            <div class="row g-0">
                            ...
                            <div class="col-12 col-lg-3 mt-5 animate__animated animate__rotateInUpRight">
                                <div class="row">
                                    ...
                                    <div class="col-12 mt-3 mb-3 d-grid">
                                        <a href='<?php echo "singleProductView.php?id=" . $product_data["id"]; ?>' class="col-12 btn btn-success">Check out</a>
                                    </div>
