            ...
            <div class="row align-content-center">
                ...
                <div class="col-12">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <P class="text-center title1 fw-bold">Welcome!</P>
                        </div>
                    </div>
                </div>
                <!-- header -->
                ...
                <div class="col-12 p-3">
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-6 justify-content-center  offset-3 " id="signUpBox">
                            <div class="row g-2">

                                <div class="col-12 text-center">
                                    <p class="title2 fst-italic">Create New Account</p>
                                </div>
                ...
                <div class="col-12 fixed-bottom d-none d-lg-block">
                    <p class="text-center">&copy; The World of Computers ComputerWorld.lk || All Right Reserved</p>
                </div>
