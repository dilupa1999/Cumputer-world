...
<head>
    ...
    <title>Update Product | Computerworld</title>
                    ...
                    <div class="col-12">
                        <div class="row">
                            ...
                            <div class="col-12 text-center">
                                <h2 class="h2 text-dark fw-bold ">Update My Products</h2>
                            </div>
                            <hr />
                            <div class="col-12">
                                <div class="row">

                                    <div class="col-12 col-lg-4 border-end border-dark text-center">
                                        <div class="row">
                                            <div class="col-12 text-center">
                                                <label class="form-label fw-bold " style="font-size: 20px;">Select Product Category</label>
                                            </div>
                                            <div class="col-6 col-lg-4 text-center offset-3 offset-lg-4 ">
                                    ...
                                    <div class="col-12 text-center">
                                        <div class="row">
                                            ...
                                            <div class="offset-0 offset-lg-2 col-12 col-lg-8 shadow-lg border-dark">
                                    ...
                                    <div class="col-12 text-center">
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-lg-8 shadow-lg border-dark offset-2">
                                    ...
                                    <div class="col-12 text-center">
                                        <div class="row text-center">
                                            ...
                                            <div class="offset-lg-3 col-12 col-lg-2 d-grid mt-3 text-center">
