...
?>
        ...
        <head>
            ...
            <title>SingleProductView| Computerworld</title>
        ...
        <body class=" main-body">
            ...
            <div class="container-fluid main-body">
                <div class="row">
                    ...
                    <div class="col-12 mt-0  singleProduct " style="background-color: #ffcccc">
                        <div class="row">
                            <div class="col-12" style="padding: 10px;">
                                <div class="row ">

                                    <div class="col-12 col-lg-2 order-2 order-lg-1 shadow-lg border border-danger rounded animate__animated animate__slideInUp offset-1 ">
                                        <ul>
                                            ...
                                            ?>
                                                    ...
                                                    <li class="d-flex flex-column justify-content-center align-items-center border border-1 border-secondary mb-1 mt-5 shadow-lg rounded">
                                                ...
                                                <li class="d-flex flex-column justify-content-center align-items-center border border-1 border-secondary mb-1 shadow-lg rounded ">
                                    ...
                                    <div class="col-12 col-lg-6 order-3 border border-dark rounded shadow-lg offset-2 animate__animated animate__rubberBand">
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <div class="row border-bottom border-dark mb-3">
                                                    <div class="col-12 my-2 mb-3 ">
                                                        <span class="fs-5 text-primary fw-bold"><b>Warrenty :</span><span class="fs-5 text-primary"> </b>6 Months Warrenty</span><br />
                                                        <span class="fs-5 text-primary fw-bold"><b>Return Policy : </span class="fs-5 text-primary"></b>1 Months Return Policy</span><br />
                                                        <span class="fs-5 text-primary fw-bold"><b>In Stock : </span><span class="fs-5 text-primary"></b><?php echo $product_data["qty"]; ?> Items Available</span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row border-bottom border-dark mb-3">
                                                    <div class="col-12 my-2 mb-3">
                                                        <div class="row g-2">
                                                            <div class="col-12 col-lg-6 border border-1 border-dark text-center shadow-lg rounded">
                                                            ...
                                                            <div class="col-12 col-lg-6 border border-1 border-dark text-center shadow-lg rounded fw-bold">
                                                            ...
                                                            <div class="my-2 offset-lg-2 col-12 col-lg-8 border border-1 border-danger rounded mb-3">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-9 col-lg-10">
                                                                        <span class="fs-5 text-dark fw-bold fw-bolder">
                            ...
                            <div class="col-12 bg-white mt-1 main-body">
                                <div class="row g-2">
                                    <div class="offset-3 offset-lg-0 col-6 col-lg-12">
                                        <div class="row justify-content-center gap-3 shadow-lg">
                                            ...
                                            ?>
                                                ...
                                                <div class="card mt-2 mb-2 align-items-center shadow-lg border border-dark pbox" style="width: 18rem;">
                                                    ...
                                                    <img src="<?php echo $image_data["code"]; ?>" class="card-img-top img-thumbnail mt-1 shadow-lg" style="height: 150px; width: auto;" />
                                                    <div class="card-body ms-0 m-0 text-center mt-3">
                                                        ...
                                                        ?>
                                                            ...
                                                            <span class="card-text text-success fw-bold"><?php echo $p_data["qty"]; ?></span><br /><br />
                                                                ...
                                                                <button class=" col-12 btn btn-success" type="submit" id="payhere-payment" onclick="payNow(<?php echo $pid; ?>);">Buy Now</button>
                            ...
                            <div class="col-6 bg-white border border-dark rounded shadow-lg">
                                <div class="row me-0 mt-4 mb-3  border-1 border-dark ">
                                    <div class="col-12 text-center">
                            ...
                            <div class="col-6 bg-white mt-2">
                                <div class="row">
                                    ...
                                    <div class="col-6 mt-2 border border-dark rounded shadow-lg">
                                        <div class="row">
                                            <div class="col-3">
                                                <label class="form-label fs-4 fw-bold text-primary">Brand: </label>
                                            </div>
                                            <div class="col-9">
                                    ...
                                    <div class="col-6 mt-2 border border-dark rounded shadow-lg ">
                                        <div class="row">
                                            <div class="col-3">
                                                <label class="form-label fs-4 fw-bold text-primary">Model: </label>
                                            </div>
                                            <div class="col-9">
                                    ...
                                    <div class="col-12 mt-2 border border-dark rounded shadow-lg">
                                        <div class="row">
                                            <div class="col-12 text-center">
                                                <label class="form-label fs-4 fw-bold">Product Description : </label>
                                            </div>
                                            <div class=" border border-dark shadow-lg rounded">
                                                <textarea cols="60" rows="10" class="form-control fw-bold" readonly><?php echo $product_data["description"]; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-6 mt-3 shadow-lg">
