...
<body class=" shadow-lg rounded mt-1">

  

    <div class="col-12 border-dark shadow" style="background-color:#74EBD5;background-image: linear-gradient(90deg,#74EBD5 0%,#9FACE6 100%);">
        <div class="row mt-1 mb-1">
            ...
            <div class="col-12 col-lg-3 offset-lg-5 align-self-end" style="text-align: center;">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-6 dropdown border-danger">
