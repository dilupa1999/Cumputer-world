...
if (isset($_POST["email"]) && isset($_POST["name"])) {
    if ($_SESSION["au"]["email"] == $_POST["email"]) {
        ...
        if($category_num == 0) {
            ...
            $mail->SMTPAuth = true;
            $mail->Username = 'mea48402@gmail.com'; 
            $mail->Password = 'lmnpzckhwqqxroag'; 
            $mail->SMTPSecure = 'ssl';
            $mail->Port = 465;
            $mail->setFrom('mea48402@gmail.com', 'Admin Verification');
            $mail->addReplyTo('mea48402@gmail.com', 'Admin Verification');
            $mail->addAddress($umail);
            $mail->isHTML(true);
            $mail->Subject = 'ComputerWorld Admin Verification Code for Add New Category';
