...
<head>
    ...
    <title>Purchasing History | Computerworld</title>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            ?>
                ...
                <div class="c12 text-center mb-3 main-body animate__animated animate__lightSpeedInLeft">
                ...
                ?>
                    ...
                    <div class="col-12 mt-3">
                        <div class="row main-body">
                            ...
                            <div class="col-12 d-none d-lg-block bg-light text-center animate__animated animate__zoomIn ">
                                <div class="row ">
                                    <div class="col-1 ">
                                        <label class="form-label fw-bold mt-3">Order_id</label>
                                    </div>
                                    <div class="col-3 ">
                                    ...
                                    <div class="col-2  text-end">
                                        <label class="form-label fw-bold mt-3">Amount</label>
                                    </div>
                                    <div class="col-2  text-end">
                                        <label class="form-label fw-bold mt-3">Purchased Date & Time</label>
                                    </div>
                                    <div class="col-3 "></div>
                                    <div class="col-12">
                                        <hr />
                            ...
                            ?>
                                ...
                                <div class="col-12 ">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-lg-1 bg-light text-center text-lg-start rounded shadow-lg align-self-center animate__animated animate__rollIn ">
                                            <label class="form-label text-dark fs-6 py-5 text-center"><?php echo $invoice_data["order_id"]; ?></label>
                                        </div>
                                        <div class="col-12 col-lg-3 animate__animated animate__rollIn">
                                        ...
                                        <div class="col-12 col-lg-1 text-center text-lg-end animate__animated animate__rollIn">
                                            <label class="form-label fs-4 py-5"><?php echo $invoice_data["qty"]; ?></label>
                                        </div>
                                        <div class="col-12 col-lg-2 bg-light text-center text-lg-end align-self-center rounded animate__animated animate__zoomInUp ">
                                            <label class="form-label  fs-5 py-5">Rs. <?php echo $invoice_data["total"]; ?> .00</label>
                                        </div>
                                        <div class="col-12 col-lg-2 text-center text-lg-end animate__animated animate__zoomInUp">
                                            <label class="form-label fs-5 py-5 px-3"><?php echo $invoice_data["date"]; ?></label>
                                        </div>
                                        <div class="col-12 col-lg-3 animate__animated animate__zoomInUp">
                                            <div class="row">
