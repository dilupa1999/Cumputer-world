...
<head>
    ...
    <title>Advanced Search | Computerworld</title>
...
<body class=" main-body">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12  mb-2  shadow-lg rounded container-fluid pbox" style="background-color: #ff4d4d;">
                <div class="row">
                    <div class="offset-lg-4 col-12 col-lg-4 ">
                        <div class="row">
                            ...
                            <div class="col-10 text-center  ">
                                <p class="fs-1 text-black-50 fw-bold mt-3 pt-2 animate__animated animate__heartBeat  ">Search Your Desires.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class=" col-4 col-lg-4 rounded mb-2 border shadow p-3 mb-5  " style="background-color: #808080;">
                <div class="row">

                    <div class="offset-lg-1 col-12 col-lg-10  shadow-lg p-3 mb-5 bg-body rounded pbox ">
                        <div class="row">
            ...
            <div class="col-8 col-lg-8 bg-body rounded mb-2 border shadow p-3 mb-5">
                <div class="row">
