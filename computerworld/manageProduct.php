...
<head>
    ...
    <title>Manage Products | Admins | Computerworld</title>
...
<body class=" main-body">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class=" mt-2 col-10 offset-1 bg-light text-center rounded shadow-lg " style="background-color:#74EBD5;background-image: linear-gradient(90deg,#74EBD5 0%,#9FACE6 100%);">
            ...
            <div class="col-12 mt-3 mb-3">
                <div class="row">
                    ...
                    <div class="col-2 col-lg-1 bg-white d-none d-lg-block bg-light py-2 shadow-lg rounded">
            ...
            ?>
                ...
                <div class="col-12 mt-3 mb-2">
                    <div class="row">
                        ...
                        <div class="col-2 d-none d-lg-block bg-light py-2 shadow-lg rounded" onclick="viewProductModal('<?php echo $selected_data['id']; ?>');">
            ...
            <div class="col-12 text-center">
                <h3 class="text-black-50 fw-bold">Category List & Add New Category,</h3>
            </div>
            <hr />
                ...
                <div class="row gap-1 justify-content-center">
                    ...
                    ?>
                        ...
                        <div class="col-12 col-lg-3 border border-danger rounded" style="height: 50px;">
                            <div class="row">
                                <div class="col-8 mt-2 mb-2 text-center">
