...
?>
    ...
    <div class="offset-2 offset-md-1 offset-lg-0 col-8 card mt-2 mb-2 align-items-center gap-md-5 ms-lg-4 pbox1 shadow-lg animate__animated animate__fadeInLeft" style="width: 15rem;">
